...
# --- PAGE CONFIGURATION ---
st.set_page_config(page_title="PrismAI V1", page_icon="🧠", layout="wide")
...
# --- MAIN UI ---
st.markdown('<div class="main-title">PrismAI Engine</div>', unsafe_allow_html=True)
