...
def main():
    ...
    csv_file = open("logs/training_history.csv", mode='w', newline='')
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        csv_writer.writerow([epoch, train_loss, val_metrics['loss'], val_metrics['acc'], 
                             val_metrics['precision'], val_metrics['recall'], val_metrics['f1'], val_metrics['auc']])
        
        if val_metrics['f1'] > best_f1:
            best_f1 = val_metrics['f1']
            torch.save(model.state_dict(), "weights/best_prism_model.pth")
